...
import com.example.lab_03.service.TeamService;
...
public class EditTeamView implements Serializable {
    ...
    public void onEditTeam() throws SQLException {
        teamService.editTeam(new Team(this.id, this.name, this.foundingDate, this.country));
    }

    public void onAddTeam() throws SQLException {
        teamService.addTeam(new Team(this.id, this.name, this.foundingDate, this.country));
    }
